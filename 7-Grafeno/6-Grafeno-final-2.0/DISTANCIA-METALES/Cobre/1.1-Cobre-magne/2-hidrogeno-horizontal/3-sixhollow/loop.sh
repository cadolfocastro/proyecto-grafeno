#!/bin/bash
for i in 2.8 2.6 2.4 2.2 2.0 1.8
do
distance_Z=$i
...
prefix = 'cobre-sixhollow-distance-$distance_Z' ,
verbosity = 'high'
/
&SYSTEM
  ibrav = 4,
...
cd /home/cristian/Escritorio/Proyecto_Grafeno/7-Grafeno/6-Grafeno-final-2.0/DISTANCIA-METALES/1.1-Cobre-magne/2-hidrogeno-horizontal/4-bridge2
scriptPath="/home/cristian/Escritorio/Proyecto_Grafeno/7-Grafeno/6-Grafeno-final-2.0/DISTANCIA-METALES/1.1-Cobre-magne/2-hidrogeno-horizontal/4-bridge2"
scriptName="loop.sh"
