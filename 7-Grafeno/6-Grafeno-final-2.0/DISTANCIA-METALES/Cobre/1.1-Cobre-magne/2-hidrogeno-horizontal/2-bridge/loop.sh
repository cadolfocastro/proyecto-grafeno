...
prefix = 'cobre-bridge-distance-$distance_Z' ,
verbosity = 'high'
/
&SYSTEM
  ibrav = 4,
...
cd /home/cristian/Escritorio/Proyecto_Grafeno/7-Grafeno/6-Grafeno-final-2.0/DISTANCIA-METALES/1.1-Cobre-magne/2-hidrogeno-horizontal/3-sixhollow
scriptPath="/home/cristian/Escritorio/Proyecto_Grafeno/7-Grafeno/6-Grafeno-final-2.0/DISTANCIA-METALES/1.1-Cobre-magne/2-hidrogeno-horizontal/3-sixhollow"
scriptName="loop.sh"
