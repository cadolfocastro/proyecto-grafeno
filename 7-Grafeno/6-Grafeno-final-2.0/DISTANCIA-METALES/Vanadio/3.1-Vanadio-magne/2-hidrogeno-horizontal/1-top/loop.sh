...
prefix = 'vanadio-top-distance-$distance_Z' ,
verbosity = 'high'
/
&SYSTEM
  ibrav = 4,
...
cd /home/cristian/Escritorio/Proyecto_Grafeno/7-Grafeno/6-Grafeno-final-2.0/DISTANCIA-METALES/3.1-Vanadio-magne/2-hidrogeno-horizontal/2-bridge
scriptPath="/home/cristian/Escritorio/Proyecto_Grafeno/7-Grafeno/6-Grafeno-final-2.0/DISTANCIA-METALES/3.1-Vanadio-magne/2-hidrogeno-horizontal/2-bridge"
scriptName="loop.sh"
