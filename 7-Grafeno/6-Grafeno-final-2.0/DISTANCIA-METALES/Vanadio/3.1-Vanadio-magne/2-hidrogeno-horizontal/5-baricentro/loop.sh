#!/bin/bash
for i in 3.5 3.0 2.8 2.6 2.4 2.2 2.0 1.8
do
distance_Z=$i
...
prefix = 'vanadio-baricentro-distance-$distance_Z' ,
verbosity = 'high'
/
&SYSTEM
  ibrav = 4,
...
H       2.911027124  5.693360355   $i
H       3.663099142  5.693360355   $i
...
cd /home/cristian/Escritorio/Proyecto_Grafeno/7-Grafeno/6-Grafeno-final-2.0/DISTANCIA-METALES/4.0-Manganeso/2-hidrogeno-horizontal/1-top
scriptPath="/home/cristian/Escritorio/Proyecto_Grafeno/7-Grafeno/6-Grafeno-final-2.0/DISTANCIA-METALES/4.0-Manganeso/2-hidrogeno-horizontal/1-top"
scriptName="loop.sh"
