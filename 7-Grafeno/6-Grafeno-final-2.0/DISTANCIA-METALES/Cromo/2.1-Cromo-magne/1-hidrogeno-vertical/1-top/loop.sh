...
do
distance_Z=$i
distance_Z2=$(echo $distance_Z + 0.752072018 | bc)
...
H        2.465297350   5.693360355   $distance_Z
H        2.465297350   5.693360355   $distance_Z2
...
do
distance_Z=$i
mpirun -np 8 pw.x  -inp distance-$distance_Z.in > distance-$distance_Z.out
done


cd /home/cristian/Escritorio/Proyecto_Grafeno/7-Grafeno/6-Grafeno-final-2.0/DISTANCIA-METALES/2.1-Cromo-magne/1-hidrogeno-vertical/2-bridge
scriptPath="/home/cristian/Escritorio/Proyecto_Grafeno/7-Grafeno/6-Grafeno-final-2.0/DISTANCIA-METALES/2.1-Cromo-magne/1-hidrogeno-vertical/2-bridge"
scriptName="loop.sh"
