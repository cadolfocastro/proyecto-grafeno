...
#Después de que se terminen de ejecutar todos los .in, busca en la siguiente carpeta el otro .sh para ejecutarlo como si fuera todo un código en cadena
	 ...
	 cd /home/cristian/Escritorio/Proyecto_Grafeno/7-Grafeno/6-Grafeno-final-2.0/3-hidrogeno-horizontal/5-baricentro
	scriptPath="/home/cristian/Escritorio/Proyecto_Grafeno/7-Grafeno/6-Grafeno-final-2.0/3-hidrogeno-horizontal/5-baricentro"
	scriptName="loop.sh"
