...
/
ATOMIC_SPECIES
H1   1.00794    H.pbe-rrkjus.UPF
H2   1.00794    H.pbe-rrkjus.UPF
C   12.01070    C.pbe-n-rrkjus_psl.1.0.0.UPF 
ATOMIC_POSITIONS (angstrom)
H1       2.089261341   5.693360355   $distance_Z
H2       2.841333359   5.693360355   $distance_Z
...
#Después de que se terminen de ejecutar todos los .in, busca en la siguiente carpeta el otro .sh para ejecutarlo como si fuera todo un código en cadena
	...
	cd /home/cristian/Escritorio/Proyecto_Grafeno/7-Grafeno/6-Grafeno-final-2.0/3-hidrogeno-horizontal/2-bridge
	scriptPath="/home/cristian/Escritorio/Proyecto_Grafeno/7-Grafeno/6-Grafeno-final-2.0/3-hidrogeno-horizontal/2-bridge"
	scriptName="loop.sh"
