#!/bin/bash
for i in 6.0 5.0 4.5 4.0 3.5 3.0 2.8 2.6 2.4 2.2 2.0 1.8 1.4 1.0
do
distance_H1=$i
...
H1       3.0816216875  6.049195377  $distance_H1
H2       3.0816216875  6.049195377  $distance_H2
...
do
distance_H1=$i
mpirun -np 5 pw.x  -inp distance-$distance_H1.in > distance-$distance_H1.out
done

cd /home/cristian/Escritorio/Proyecto_Grafeno/7-Grafeno/6-Grafeno-final-2.0/2-hidrogeno-vertical/3-sixhollow/
scriptPath="/home/cristian/Escritorio/Proyecto_Grafeno/7-Grafeno/6-Grafeno-final-2.0/2-hidrogeno-vertical/3-sixhollow/"
scriptName="loop.sh"
